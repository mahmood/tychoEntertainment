<?php get_header(); ?>
          ...
          <div class="column is-half is-offset-3">
            <div class="trusted__item">
              <div class="trusted__item__desc">
                <p>Weve worked with Tycho for the past 7 years on many events. Most notably, the SAG Awards Gala and they have always over delivered. No job is too small and always with a smile</p>
              </div>
              <div class="name-of-event">Event Eleven</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="about">
      <div class="container is-fluid">
        <h2 class="title">Your Full-Service Entertainment and Event Partner</h2>
        <div class="a-man-has-arrow is-hidden-mobile"><i class="icon-logo-orange"></i></div>
        <div class="columns">
          <div class="column is-half">
            <div class="about__item">
              <p>Our team of staffers and cleaners seamlessly execute best-in-class events while you produce and direct. Our team is trained in best-practices and committed to pre, during, and post event excellence.</p>
              <p>From bartenders and security to cleaners and hostesses, Tycho Entertainment offers a full-suite of professional and detail-oriented staffing resources for any size event.</p>
              <div class="about__item__button btn"><i class="icon-circle-plus"></i><a href="#">Request Services</a></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="event__box__item tile is-ancestor">
              ...
              <div class="event__box__item__desc tile is-parent">
                <div class="tile is-child">
                  ...
                  <p>Here to assist in the logistics of keeping your party running smooth. Our event staffers are here to make your life easy.</p>
                </div>
              </div>
            </div>
            <div class="event__box__item tile is-ancestor">
          ...
          <div class="column is-half">
            <div class="who-we-are__items">
              <div class="who-we-are__items__item">
                ...
                <p>We work hard to provide the best people to power your event needs. Tycho Entertainment staffers are trained in event management and execution best-practices. We take pride in working behind the scenes to create the experience you imagined for you and your guest.</p>
              </div>
              <div class="who-we-are__items__item">
                <h2 class="title">Values</h2>
                <p>We believe in professionalism at every point of contact with our clients. With attention to detail at the cornerstone of our practice, we make managing your event frictionless and delightful. “At Your Service” is the philosophy of how we do business.</p>
              </div>
              <div class="who-we-are__items__item">
                <h2 class="title">Vision</h2>
                <p>At Tycho Entertainment, we view our clients as partners. Our relationship begins before your event and carries on through your next 10. We are committed to excellence and always “at your service.”</p>
              </div>
            </div>
          </div>
        </div>
